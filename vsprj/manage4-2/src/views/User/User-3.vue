<template>
    <div class="manage">
        <div class="manage-header">
            ...
            <MyForm :inline="true" :formLabel="searchFormLabel" :model="searchFrom">
        ...
        <MyTable :data="tableData" v-model:page="config.page" :total="config.total" :pageSize="config.limit" @changePage="getList()"
    ...
    <el-dialog :title="operateType === 'add' ? '新增用户' : '更新用户'" v-model="isShow">
        <MyForm :inline="false" :formLabel="operateFormLabel" :model="operateForm"></MyForm>
    ...
    <!-- <MyForm :inline="true" :formLabel="searchFormLabel" :model="searchFrom">
        <button @click.prevent="console.log('xxx')">确定</button>
    </MyForm> -->
</template>
